        ...
        <table className="w-full text-xs text-left border-collapse min-w-[1050px]">
          ...
          <thead className="bg-[#0b2545] text-white font-extrabold text-[10px] uppercase tracking-wider">
            <tr>
              ...
              <th className="py-2.5 px-3 text-right border-r border-slate-700 w-28">EXPENDITURE (RS.)</th>
              <th className="py-2.5 px-3 text-right border-r border-slate-700 w-32">UNSPENT BUDGET (RS.)</th>
